  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto flex flex-col items-start gap-6 pointer-events-none">
        ...
        <button className="hero-anim pointer-events-auto btn-primary mt-4 px-8 py-4 rounded-xl text-lg flex items-center justify-center gap-3 w-full md:w-auto" onClick={() => isAuthenticated ? navigate('/dashboard') : openAuthModal()}>
          Start Cooking
          <ArrowRight size={20} />
        </button>
      </div>
